...
import 'package:flutter_guess_it/features/game/presentation/widgets/letter_box_widget.dart';
      ...
      builder: (context, state) {
        ...
        return Row(
          children: List.generate(word.length, (letterIndex) {
            ...
            var boxColor = _getBoxColor(context, text, word, attemptIndex,
                letterIndex, previousAttempts, isCurrentAttempt);
            var textColor = _getTextColor(context, text, word, attemptIndex,
                letterIndex, previousAttempts, isCurrentAttempt);
            return Expanded(
